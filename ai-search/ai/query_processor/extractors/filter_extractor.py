...
from ai.query_processor.models import (
    ...
    ExtractedEntity, EntityType, Filter, FilterType,
)
...
class FilterExtractor(IExtractor):
    ...
    def __init__(self):
        self._filter_patterns: list[tuple[FilterType, list[str], str]] = [
            (FilterType.COST, [r'\bfree\b', r'\bopen\s*source\b', r'\bfreeware\b', r'\bgratis\b'], "free"),
            (FilterType.COST, [r'\bpaid\b', r'\bcommercial\b', r'\bpremium\b', r'\benterprise\b'], "paid"),
            (FilterType.LICENSE, [r'\bmit\b', r'\bmit\s+license\b'], "MIT"),
            (FilterType.LICENSE, [r'\bgpl\b', r'\bgplv\d\b', r'\bgnu\b'], "GPL"),
            (FilterType.LICENSE, [r'\bapache\b', r'\bapache\s+2\.0\b', r'\bapache\s+license\b'], "Apache-2.0"),
            (FilterType.LICENSE, [r'\bb\s?sd\b', r'\bbSD\b', r'\bbSD\s+license\b'], "BSD"),
            (FilterType.PLATFORM, [r'\bcross\s*platform\b', r'\bmulti\s*platform\b'], "cross-platform"),
            ...
            (FilterType.POPULARITY, [r'\bpopular\b', r'\bmost\s+starred\b', r'\bhighly\s+rated\b'], "popular"),
            (FilterType.MAINTAINED, [r'\bactive\b', r'\bmaintained\b', r'\bactively\s+maintained\b'], "active"),

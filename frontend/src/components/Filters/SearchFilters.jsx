...
import { Filter, X, SlidersHorizontal, Eye, Star, GitFork, Shield, Calendar } from 'lucide-react';
...
export default function SearchFilters({
    ...
    <div className="space-y-6 text-left">
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full text-sm px-3 py-2 border border-brand-gray-200 dark:border-brand-gray-800 bg-brand-gray-50 dark:bg-brand-gray-950 rounded-xl text-brand-gray-800 dark:text-brand-gray-200 focus:outline-none focus:border-accent-blue-500 cursor-pointer"
        >
            ...
            <button
              ...
              className={`px-3 py-1 rounded-full text-xs font-medium border transition-colors cursor-pointer ${
                filters.language === lang
                  ? 'bg-brand-gray-950 dark:bg-white text-white dark:text-black border-brand-gray-950 dark:border-white shadow-sm'
                  : 'bg-white dark:bg-brand-gray-900 border-brand-gray-200 dark:border-brand-gray-800 text-brand-gray-600 dark:text-brand-gray-400 hover:bg-brand-gray-50 dark:hover:bg-brand-gray-850'
              }`}
            >
              {lang}
            </button>
  ...
  return (
    <>
      ...
      {/* Mobile Collapsible Drawer (Slide out overlay) */}
      <AnimatePresence>
        {isOpen && (

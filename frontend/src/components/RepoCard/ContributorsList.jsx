      ...
      <div className="space-y-3">
        {contributors.map((contrib, idx) => (
          <div key={idx} className="flex items-center justify-between py-1.5 border-b border-brand-gray-100 dark:border-brand-gray-850/50 last:border-0 last:pb-0">
            ...
            <span className="text-[10px] font-bold font-mono px-2 py-0.5 rounded bg-brand-gray-50 dark:bg-brand-gray-950 border border-brand-gray-200/50 dark:border-brand-gray-800 text-brand-gray-500 dark:text-brand-gray-450">

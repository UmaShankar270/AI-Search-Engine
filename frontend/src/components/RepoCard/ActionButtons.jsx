  ...
  return (
    <div className="flex flex-wrap gap-3 items-center justify-start w-full">
      <a
        ...
        className="inline-flex items-center space-x-2 px-4 py-2.5 rounded-xl text-sm font-semibold bg-brand-gray-955 dark:bg-white text-white dark:text-black hover:bg-brand-gray-800 dark:hover:bg-brand-gray-100 transition-colors shadow-sm cursor-pointer"
      >
      ...
      <button
        ...
        className={`inline-flex items-center space-x-2 px-4 py-2.5 rounded-xl text-sm font-semibold border transition-colors cursor-pointer ${
          isComparing
            ...
            : 'text-brand-gray-700 border-brand-gray-200 dark:border-brand-gray-850 hover:bg-brand-gray-50 dark:hover:bg-brand-gray-800 text-brand-gray-800 dark:text-brand-gray-305'
        }`}
      >
      ...
      <button
        ...
        className="inline-flex items-center space-x-2 px-4 py-2.5 rounded-xl text-sm font-semibold border border-brand-gray-200 dark:border-brand-gray-800 bg-white dark:bg-brand-gray-900 text-brand-gray-700 dark:text-brand-gray-305 hover:bg-brand-gray-50 dark:hover:bg-brand-gray-850 transition-colors cursor-pointer"
      >
        {copied ? (
          <>
      ...
      <button
        ...
        className="inline-flex items-center space-x-2 px-4 py-2.5 rounded-xl text-sm font-semibold border border-brand-gray-200 dark:border-brand-gray-800 bg-white dark:bg-brand-gray-900 text-brand-gray-750 dark:text-brand-gray-305 hover:bg-brand-gray-50 dark:hover:bg-brand-gray-850 transition-colors cursor-pointer"
      >
        {shared ? (
          <>
            <Check className="w-4 h-4 text-emerald-500" />

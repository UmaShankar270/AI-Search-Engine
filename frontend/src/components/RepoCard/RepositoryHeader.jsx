...
export default function RepositoryHeader({ details }) {
  ...
  return (
    <div className="border border-brand-gray-200 dark:border-brand-gray-800 bg-white dark:bg-brand-gray-900 rounded-2xl p-6 md:p-8 shadow-sm text-left space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center space-x-3.5 truncate">
          ...
          <div className="truncate">
            ...
            <h1 className="text-xl md:text-3xl font-extrabold text-brand-gray-950 dark:text-white truncate tracking-tight">
              {details.name}
            </h1>
          </div>
        </div>
      ...
      <div className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-3 border-t border-brand-gray-100 dark:border-brand-gray-800/60 text-xs text-brand-gray-400 dark:text-brand-gray-500">

...
import { Star, GitFork, AlertCircle, Shield, Calendar, ExternalLink, GitCompare, Minus, CheckCircle2 } from 'lucide-react';
...
export default function RepoCard({ repo }) {
  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col justify-between border border-brand-gray-200 dark:border-brand-gray-800 bg-white dark:bg-brand-gray-900 rounded-2xl p-6 shadow-sm hover:border-brand-gray-300 dark:hover:border-brand-gray-700 hover:shadow-md transition-all duration-200"
    >
      <div>
        {/* Header Block: Avatar, Name & Score */}
        <div className="flex items-start justify-between gap-4 mb-4">
          <div className="flex items-center space-x-3 truncate">
            ...
            <Link
              ...
              className="text-base font-bold text-brand-gray-950 dark:text-white hover:text-accent-blue-500 transition-colors truncate"
            >
        ...
        {/* Description */}
        <p className="text-sm text-brand-gray-500 dark:text-brand-gray-400 mb-4 line-clamp-2 leading-relaxed text-left">
          {repo.description}
        </p>

        {/* "Why this repository matches" Box */}
        {repo.matchReasonBullets && repo.matchReasonBullets.length > 0 && (
          <div className="p-4 bg-brand-gray-50 dark:bg-brand-gray-950 border border-brand-gray-100 dark:border-brand-gray-850 rounded-xl mb-4 text-left">
        ...
        <div className="flex flex-wrap gap-2 pt-1.5 w-full justify-between items-center">
          <div className="flex items-center space-x-1.5">
            ...
            <a
              ...
              className="inline-flex items-center space-x-1 px-2.5 py-1.5 text-xs text-brand-gray-400 hover:text-brand-gray-900 dark:hover:text-white transition-colors"
            >
              <span>GitHub</span>
          ...
          <button
            ...
            className={`flex items-center space-x-1 px-3 py-1.5 rounded-lg border text-xs font-semibold transition-colors cursor-pointer ${
              isComparing
                ? 'text-red-600 dark:text-red-400 border-red-200 dark:border-red-900/50 bg-red-50 dark:bg-red-950/20 hover:bg-red-100 dark:hover:bg-red-950/40'
                : compareCount >= 2
                ? 'text-brand-gray-300 dark:text-brand-gray-750 border-brand-gray-150 dark:border-brand-gray-900 cursor-not-allowed'
                : 'text-brand-gray-700 dark:text-brand-gray-300 border-brand-gray-200 dark:border-brand-gray-800 hover:bg-brand-gray-50 dark:hover:bg-brand-gray-850'
            }`}
          >
            {isComparing ? (
              <>

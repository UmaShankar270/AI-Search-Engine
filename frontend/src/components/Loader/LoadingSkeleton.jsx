...
// Card loading skeleton matching RepoCard's visual height and layout
export function SkeletonCard() {
  return (
    <div className="border border-brand-gray-200 dark:border-brand-gray-800 bg-white dark:bg-brand-gray-900 rounded-xl p-5 space-y-4 animate-pulse">
      {/* Header */}

...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b border-brand-gray-200 dark:border-brand-gray-800 bg-white/70 dark:bg-brand-gray-955/70 backdrop-blur-md glass-effect">
      ...
      {isOpen && (
        <div className="md:hidden border-t border-brand-gray-200 dark:border-brand-gray-800 bg-white dark:bg-brand-gray-955 px-2 pt-2 pb-4 space-y-1">
          {navItems.map((item) => (
            <Link
              key={item.name}
              to={item.path}

...
export default function NotFound() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 flex-1 flex flex-col items-center justify-center text-center">
      ...
      <h1 className="text-4xl font-extrabold text-brand-gray-950 dark:text-white mb-2 tracking-tight">
        404 - Page Not Found
      </h1>
      ...
      <Link
        to="/"
        className="flex items-center space-x-2 px-5 py-2.5 text-sm font-medium text-white bg-brand-gray-950 dark:bg-white dark:text-black rounded-lg hover:bg-brand-gray-800 dark:hover:bg-brand-gray-100 transition-colors shadow-sm focus:outline-none"
      >
